...
def main():
    log_filename = "log_execucao_pmv.md"
    demanda_bruta = ""
    ...
    try:
        ...
        # Demanda bruta padrão se nenhuma for provida via linha de comando
        default_demand = (
        ...
        # Captura a demanda se fornecida como argumento
        if len(sys.argv) > 1:
        ...
        print("  1. gate_elementos.md       -> Validação da Classificação dos Elementos")
        print("  2. gate_condicionantes.md  -> Validação dos Condicionantes pós Análise Estrutural")
        print("  3. gate_consistencia.md    -> Laudo de Auditoria de Consistência dos Cenários")
        ...
        try:
            ...
            log_file.write("- 📁 **GATE 1 - Classificação dos Elementos**: [gate_elementos.md](file:///gate_elementos.md)\n")
            log_file.write("- 📁 **GATE 2 - Validação de Condicionantes**: [gate_condicionantes.md](file:///gate_condicionantes.md)\n")
            log_file.write("- 📁 **GATE 3 - Auditoria de Consistência dos Cenários**: [gate_consistencia.md](file:///gate_consistencia.md)\n\n")
            log_file.write("---\n\n")
        ...
        try:
            ...
            gerar_pdf_log(conteudo_log, "log_execucao_pmv.pdf")
            print("[PMV] Log de execução convertido em PDF com sucesso: 'log_execucao_pmv.pdf'.")
